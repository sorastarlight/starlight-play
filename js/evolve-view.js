(() => {
  ...
  function resultModel(result, pick) {
    ...
    return {
      ...
      fromFormId: evo.fromFormId || evo.formIdFrom || pick?.formId || pick?.pokemonFormId || null,
      toFormId: evo.toFormId || evo.formIdTo || evo.formId || pick?.toFormId || pick?.pokemonFormId || null,
      favorite: Boolean(evo.favorite != null ? evo.favorite : pick?.favorite),
