-- Play snapshot must read the latest round the same way Admin Hub does.
-- Calling sync_latest_round() here was wiping the round off the Play payload.
...
drop function if exists private.debug_snap();
