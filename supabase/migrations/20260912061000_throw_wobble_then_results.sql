-- When Throw hits 0, post every trainer's throw to LIVE immediately.
-- Then wobble through the reveal clock. Only roll catches when reveal hits 0.
...
set game_settings = jsonb_set(coalesce(game_settings, '{}'::jsonb), '{revealSeconds}', '10'::jsonb)
where id = 1;
