...
as $$
  select coalesce(p_id, '') in (
    ...
    'pride-trans', 'pride-rainbow', 'pride-lesbian', 'pride-bi',
    'pride-pan', 'pride-nb', 'pride-ace', 'pride-gf',
    'pride-mlm', 'pride-intersex'
  );
$$;
...
as $$
  select coalesce(p_id, '') in (
    ...
    'ash-sinnoh', 'ash-unova', 'ash-kalos', 'ash-alola', 'ash-ashley',
