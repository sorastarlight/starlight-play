  ...
  select jsonb_build_object(
    ...
    'bits', jsonb_build_array(
      jsonb_build_object(
        ...
        'blurb','+10 bag · 8 Poké Balls · 4 Great Balls · 1 Ultra Ball · 4 Berry · 3 Bait'
      ),
      jsonb_build_object(
        'sku','bits-pantry','name','Picnic Pack','bits',150,
        'grants',jsonb_build_object('bag_bonus',10,'berry',10,'bait',8,'greatball',4),
        'blurb','+10 bag · 10 Berry · 8 Bait · 4 Great Balls'
      ),
      jsonb_build_object(
        ...
        'blurb','+10 bag · 8 Great Balls · 5 Poké Balls · 1 Ultra Ball · 4 Berry · 3 Bait'
      ),
      jsonb_build_object(
      ...
      jsonb_build_object(
        ...
        'blurb','+20 bag · 8 Ultra Balls · 6 Great Balls · 6 Poké Balls · 1 Lure · 4 Berry · 3 Bait'
      )
    )
  );
$$;
